...
public static class SyntaxFacts
{
    ...
    public static SyntaxKind GetKeywordKind(string text)
    {
        return text switch
        {
            ...
            "INVISIBLE" => SyntaxKind.InvisibleKeyword,
            ...
            "SRS" => SyntaxKind.SrsKeyword,
            "BUKKIT" => SyntaxKind.BukkitKeyword,
            "ME" => SyntaxKind.MeKeyword,
            "LIEK" => SyntaxKind.LiekKeyword,
            "KTHX" => SyntaxKind.KthxKeyword,
    ...
    public static string? GetText(SyntaxKind kind)
    {
        return kind switch
        {
            ...
            SyntaxKind.InvisibleKeyword => "INVISIBLE",
            ...
            SyntaxKind.SrsKeyword => "SRS",
            SyntaxKind.BukkitKeyword => "BUKKIT",
            SyntaxKind.MeKeyword => "ME",
            SyntaxKind.LiekKeyword => "LIEK",
            SyntaxKind.KthxKeyword => "KTHX",
            SyntaxKind.ApostrophezToken => "'Z",
