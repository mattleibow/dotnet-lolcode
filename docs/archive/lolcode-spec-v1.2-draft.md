> **Note:** This is the **original wiki draft** of the LOLCODE 1.2 spec,
> last modified 2007/07/24 by kieferskunk. It was later revised into the
> [final draft](lolcode-spec-v1.2.md) (by justinmeza) which changed
> `HOW DUZ I` to `HOW IZ I` for function definitions, and wrapped
> function calls in `I IZ ... MKAY` syntax.
...
11. A single-line comment is always terminated by a newline. Line continuation (…) and soft-command-breaks (,) after the comment (BTW) are ignored.
...
*from [1.1](https://web.archive.org/web/20130119010044/http://lolcode.com/specs/1.1)*
...
*modified from [1.1](https://web.archive.org/web/20130119010044/http://lolcode.com/specs/1.1)*
...
*updated from [1.1](https://web.archive.org/web/20130119010044/http://lolcode.com/specs/1.1)*
...
`:[<char name>]` resolves the \<char name\> in capital letters to the corresponding Unicode [normative name](https://web.archive.org/web/20130119010044/http://www.unicode.org/Public/4.1.0/ucd/NamesList.txt).
...
*GIMMEH is defined minimally here as a holdover from [1.0](https://web.archive.org/web/20130119010044/http://lolcode.com/specs/1.0) and because there has not been any detailed discussion of this feature. We count on the liberal casting capabilities of the language and programmer inventiveness to handle input restriction. **GIMMEH may change in a future version**.*
...
specs/1.2.txt · Last modified: 2007/07/24 00:21 by kieferskunk
