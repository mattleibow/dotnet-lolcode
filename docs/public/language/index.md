...
The stable normative source for this project is the [LOLCODE 1.2 specification](../reference/language-spec.md).
The [implementation profile](../reference/implementation-profile.md) records supported
future-reference behavior and intentional boundaries.
